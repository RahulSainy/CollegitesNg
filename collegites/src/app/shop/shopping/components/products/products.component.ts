...
import { Product } from 'src/app/shop/shared/models/product';
import { ProductService } from 'src/app/shop/shared/services/product.service';
...
export class ProductsComponent implements OnInit {
  ...
  cart$: Observable<ShoppingCartComponent> | undefined;
